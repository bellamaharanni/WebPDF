  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-start">
      ...
      <main className="max-w-4xl mx-auto text-center py-12 px-4 sm:px-6 lg:px-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">PDFs Successfully Stamped!</h1>
      ...
      <div className="flex space-x-8 mb-24">
        ...
        <button
          ...
          onClick={() => navigate("/watermarking-page2")} // Navigate to SplitPage2
        >
          Back to Editing
        </button>
      </div>
...
export default WatermarkingSuccess;
