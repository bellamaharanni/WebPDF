...
const CertificatePage = () => {
  ...
  const handleChooseFileClick = () => {
    navigate("/certificate-page2"); // Navigasi ke halaman selanjutnya
  };
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-start">
      <main className="max-w-4xl mx-auto text-center py-12 px-4 sm:px-6 lg:px-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Signature Certificate</h1>
        <p className="text-gray-600 mb-8">
          Your signature is verified, and backed by a trusted certificate for authenticity.
        </p>
